...
setup(
    ...
    packages=['venv.Lib.site-packages.pytz', 'venv.Lib.site-packages.django', 'venv.Lib.site-packages.django.db',
              ...
              'venv.Lib.site-packages.pip-9.0.1-py3.6.egg.pip.operations', 'IronTask', 'irontask_app',
              'irontask_app.test', 'irontask_app.forms', 'irontask_app.views', 'irontask_app.migrations'],
    url='',
    license='',
    author='Sebastien POUSSARD',
    author_email='',
    description=''
)
